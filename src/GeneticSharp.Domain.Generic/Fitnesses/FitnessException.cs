...
namespace GeneticSharp.Domain.Fitnesses.Generic
{
	...
	/// </summary>
	[Serializable]
    public sealed class FitnessException<T> : Exception
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneticSharp.Domain.Fitnesses.Generic.FitnessException<T>"/> class.
        /// </summary>
        ...
        public FitnessException(IFitness<T> fitness, string message, Exception innerException)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FitnessException<T>"/> class.
        /// </summary>

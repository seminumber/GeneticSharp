...
namespace GeneticSharp.Domain.Reinsertions.Generic
{
	...
	/// </summary>
	[Serializable]
    public sealed class ReinsertionException<T> : Exception
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneticSharp.Domain.Reinsertions.Generic.ReinsertionException<T>"/> class.
        /// </summary>
        ...
        public ReinsertionException(IReinsertion<T> reinsertion, string message, Exception innerException)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReinsertionException<T>"/> class.
        /// </summary>
